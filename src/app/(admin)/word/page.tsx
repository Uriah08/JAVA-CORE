        ...
        sections: [
                    ...
                    children: [
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            children: [
                              new TextRun({ text: "Symbol", size: 20 }),
                            ],
                          }),
                        ],
                      }),
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            children: [
                              new TextRun({ text: "Condition", size: 20 }),
                            ],
                          }),
                        ],
                      }),
                      ...
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            children: [
                              new TextRun({ text: "Action", size: 20 }),
                            ],
                          }),
                        ],
                      }),
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            children: [
                              new TextRun({ text: "Risk Category", size: 20 }),
                            ],
                          }),
                        ],
                      }),
          ...
          },
          {
            ...
            children: [
                      ...
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            alignment: AlignmentType.CENTER,
                            children: [
                              new TextRun({ text: "P1", size: 20, bold: true }),
                            ],
                          }),
                        ],
                      }),
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            alignment: AlignmentType.CENTER,
                            children: [
                              new TextRun({ text: "P2", size: 20, bold: true }),
                            ],
                          }),
                        ],
                      }),
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            alignment: AlignmentType.CENTER,
                            children: [
                              new TextRun({ text: "P3", size: 20, bold: true }),
                            ],
                          }),
                        ],
                      }),
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            alignment: AlignmentType.CENTER,
                            children: [
                              new TextRun({ text: "P4", size: 20, bold: true }),
                            ],
                          }),
                        ],
                      }),
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            alignment: AlignmentType.CENTER,
                            children: [
                              new TextRun({ text: "P5", size: 20, bold: true }),
                            ],
                          }),
                        ],
                      }),
                      new TableCell({
                        ...
                        children: [
                          new Paragraph({
                            alignment: AlignmentType.CENTER,
                            children: [
                              new TextRun({ text: "P6", size: 20, bold: true }),
                            ],
                          }),
                        ],
                      }),
              ...
              ...recommendations
                .map(({ equipmentName, component, priority, action, date }) => [
                  new Table({
                    width: { size: 100, type: WidthType.PERCENTAGE },
                        ...
                        children: [
                          new TableCell({
                            ...
                            children: [
                              new Paragraph({
                                children: [
                                  new TextRun({ text: component, size: 20 }),
                                ],
                              }),
                            ],
                          }),
