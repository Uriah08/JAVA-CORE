...
const About = () => {
  return (
    <div>
      <div className="w-screen h-screen grid grid-cols-[2fr_2fr_3fr] gap-10 items-center py-16 px-10">
        ...
        <div className="flex flex-col justify-center text-center md:text-left space-y-4">
          ...
          <h2 className="text-7xl font-bold max-w-48 text-gray-800">
          ...
          <button className="bg-main text-white max-w-48 py-2 rounded-lg shadow-md hover:bg-main-300">
            ━━ Read More
          </button>
        </div>
      </div>
      ...
      <div className="w-screen grid grid-cols-4">
        <div className="flex flex-col p-12 h-96 border-r border-gray-300 transition-all duration-300 hover:bg-gray-200 hover:text-main relative group">
          ...
          <ClipboardList className="w-12 h-12 text-main absolute bottom-4 right-4 transition-transform duration-300 group-hover:scale-150 group-hover:translate-x-[-10px] group-hover:translate-y-[-10px]" />
        </div>
        <div className="flex flex-col p-12 h-96 border-r border-gray-300 transition-all duration-300 hover:bg-gray-200 hover:text-main relative group">
          <h3 className="text-xl font-semibold mb-2">
        ...
        <div className="flex flex-col p-12 h-96 border-r border-gray-300 transition-all duration-300 hover:bg-gray-200 hover:text-main relative group">
          ...
          <ChartSpline className="w-12 h-12 text-main gray-700 absolute bottom-4 right-4 transition-transform duration-300 group-hover:scale-150 group-hover:translate-x-[-10px] group-hover:translate-y-[-10px]" />
        </div>
        <div className="flex flex-col p-12 h-96 transition-all duration-300 hover:bg-gray-200 hover:text-main relative group">
          <h3 className="text-xl font-semibold mb-2">
